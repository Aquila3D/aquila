...
enum class VkShaderStageFlagBits(val value: Int) {
    ...
    companion object {
        private val map = values().associateBy(VkShaderStageFlagBits::value)
        fun from(type: Int): VkShaderStageFlagBits {
            return map[type] ?: throw IllegalArgumentException("Unrecognized shader stage flag: $type")
        }
    }
}
